            ...
            <div class="col-md-8">
              <div class="grid simple form-grid">
                <div class="grid-title no-border">
                  <h4>Gestion <span class="semi-bold">de Factures</span></h4>
                  <div class="tools">
                ...
                <div class="grid-body no-border">
                  <s:form action="AjouterFacture"  name="form_traditional_validation" role="form" autocomplete="off" class="validate">
                    <div class="form-group">
                      <label class="form-label">Numero Facture</label> <span class="help">e.x. "EE300"</span>
                      <input class="form-control"  name="numFacture" type="text" value="${facture.numFacture}" required>
                    </div>
                    <div class="form-group">
                      <label class="form-label">Montant</label> <span class="help">e.x. "5000"</span>
                      <div class="input-with-icon right">
                        <i class=""></i>
                       
                        <input class="form-control" name="montant" type="number" value="${facture.montant}">
                      </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h4>List <span class="semi-bold">Factures</span></h4>
                  <div class="tools">
                    <a href="javascript:;" class="collapse"></a>
                    <a href="#grid-config" data-toggle="modal" class="config"></a>
                    <a href="javascript:;" class="reload"></a>
                ...
                <div class="grid-body ">
                  <table class="table" id="example3">
                    ...
                    <tbody>
                    <s:iterator value="f">
                    <tr class="odd gradeX"><td><s:property value="numFacture"/></td><td><s:property value="montant"/></td><td><s:property value="dateFacture"/></td>
                      
                      

					<s:url action="editFacture" var="lien30">
					...
					<s:url action="delete" var="deletlink" >
						...
						<td> <button class="btn btn-success btn-cons" ><s:a href="%{lien30}"> <span class="semi-bold" style="color:white ;">Update</span></s:a></button></td>
						<td> <button class="btn btn-danger btn-cons" ><s:a href="%{deletlink}"><span class="semi-bold" style="color:white ;">Delete</span></s:a></button></td>
