      ...
      <div class="page-content">
        ...
        <div class="content">
          ...
          <div class="page-title"> <i class="icon-custom-left"></i>
            <h3>Carte - <span class="semi-bold">Credit</span></h3>
          </div>
          <div class="row">
            <div class="col-md-8">
              <div class="grid simple form-grid">
                <div class="grid-title no-border">
                  <h4>Ajouter <span class="semi-bold">Carte Credit</span></h4>
                  <div class="tools">
                ...
                <div class="grid-body no-border">
                  <s:form action="AjouterCarte"  name="form_traditional_validation" role="form" autocomplete="off" class="validate">
                    <div class="form-group">
                      <label class="form-label">Numero Facture</label> <span class="help">e.x. "EE300"</span>
                      <input class="form-control"  name="numCarte" type="text" value="${numCarte}" required>
                    </div>
                    <div class="form-group">
                      <label class="form-label">Id</label> <span class="help">e.x. "13"</span>
                      <div class="input-with-icon right">
                        <i class=""></i>
                       
                        <input class="form-control" name="idClient" type="number" value="${idClient}">
                      </div>
                    </div>
                    
                    
                    <div class="form-group">
                      <label class="form-label">Nom</label> <span class="help">e.x. "mounir"</span>
                      <div class="input-with-icon right">
                        <i class=""></i>
                       
                        <input class="form-control" name="nomClient" type="text" value="${nomClient}">
                      </div>
                    </div>
                    
                    <div class="form-group">
                      <label class="form-label">Prenom</label> <span class="help">e.x. "5000"</span>
                      <div class="input-with-icon right">
                        <i class=""></i>
                       
                        <input class="form-control" name="prenomClient" type="text" value="${prenomClient}">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <%--  <s:textfield  class="form-control" id="form1CardHolderName" name="form1CardHolderName"   label="NumFacture" key="facture.numFacture"/> --%>
                         <input class="form-control"  name="edit" type="hidden" value="${edit}"> 
                      </div>
                    </div>
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h4>List <span class="semi-bold">Cartes</span></h4>
                  <div class="tools">
                    <a href="javascript:;" class="collapse"></a>
                    <a href="#grid-config" data-toggle="modal" class="config"></a>
                    <a href="javascript:;" class="reload"></a>
                ...
                <div class="grid-body ">
                  <table class="table" id="example3">
                    ...
                    <tbody>
                    <s:iterator value="Lc">
                    <tr class="odd gradeX"><td><s:property value="numCarte"/></td><td><s:property value="p.id"/></td><td><s:property value="p.nom"/></td><td><s:property value="p.prenom"/></td>
                      
                      

					<s:url action="editCarte" var="lien5" >

					<s:param name="num">
					<s:property value="numCarte"/>
					</s:param>
						</s:url>
						
						<s:url action="deleteCarte" var="lien4" >
						<s:param name="num">
						<s:property value="numCarte"/>
						</s:param>
						</s:url>
						...
						<td> <button class="btn btn-success btn-cons" ><s:a href="%{lien5}"> <span class="semi-bold" style="color:white ;">Update</span></s:a></button></td>
						<td> <button class="btn btn-danger btn-cons" ><s:a href="%{lien4}"><span class="semi-bold" style="color:white ;">Delete</span></s:a></button></td>
